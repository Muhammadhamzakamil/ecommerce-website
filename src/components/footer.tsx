...
const Footer = () => {
    ...
    <div className="flex flex-wrap md:text-left text-center order-first">
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          ...
          <li>
            <Link href={"#"} className='text-base font-semibold tracking-tight text-myBlackPara hover:text-myBlackPara/70'>About us</Link>
          </li>
          <li>
            <Link href={"#"} className='text-base font-semibold tracking-tight text-myBlackPara hover:text-myBlackPara/70'>Contact us</Link>
          </li>
      ...
      <h2 className="scroll-m-20 text-lg font-semibold tracking-tight text-myBlackHead mb-3">
        ...
        <li>
          ...
          <li>
            <Link href={"#"} className='text-base font-semibold tracking-tight text-myBlackPara hover:text-myBlackPara/70'>Cookei policy</Link>
          </li>
        </nav>
      </div>
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
      <h2 className="scroll-m-20 text-lg font-semibold tracking-tight text-myBlackHead mb-3">
       SUBSCRIBE
        ...
        <div className="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
          ...
          <button className="lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex text-white bg-myBlackPara border-0 py-2 px-6 focus:outline-none hover:bg-myBlackHead rounded">
          Get Notified
          </button>
        </div>
        <p className=" mt-2 md:text-left text-center
        text-xs font-semibold tracking-tight text-myBlackPara hover:text-myBlackPara/70">
  ...
  <div >
    <div className="container px-5 py-5 mx-auto flex items-center sm:flex-row flex-col">
      ...
      <Image 
    src={require(`/public/pictures/Logo.jpg`)} alt='Logo' width={120} height={120} />
        
      </a>
      <p className="text-xs font-semibold tracking-tight text-myBlackPara hover:text-myBlackPara/70 cursor-pointer sm:ml-6 sm:mt-0 mt-4">
        © 2023 H.K Mart —
